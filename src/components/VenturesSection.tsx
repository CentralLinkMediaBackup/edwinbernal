      ...
      <div className="container relative z-10 px-6">
        <Reveal className="text-center mb-16">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold mb-4">
            <SplitWords
              text="My Ventures"
              wordClassName={(word) => (word === "Ventures" ? "text-gradient-gold" : undefined)}
            />
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          ...
          <Reveal direction="right" className="lg:col-span-2" delay={0.1}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="glass-card p-4 text-center">
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <CountUp value={11} className="text-3xl font-bold text-gradient-blue" />
                  </div>
                ...
                <div className="glass-card p-4 text-center">
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <CountUp value={16} suffix="+" className="text-3xl font-bold text-gradient-gold" />
                  </div>
                ...
                <div className="glass-card p-4 text-center">
                  <div className="flex items-center justify-center mb-2">
                    ...
                    <CountUp value={3} className="text-3xl font-bold text-gradient-blue" />
                  </div>
            ...
            <SpotlightCard className="p-8 h-full">
              ...
              <div className="space-y-4">
                <div className="glass-card p-3 text-center">
                  <CountUp value={53} suffix="K+" className="text-2xl font-bold text-gradient-gold" />
                  <p className="text-xs text-muted-foreground">Followers</p>
                </div>
                <div className="glass-card p-3 text-center">
                  <CountUp value={1} suffix="M+" className="text-2xl font-bold text-gradient-blue" />
          ...
          <Reveal direction="left" className="lg:col-span-2" delay={0.1}>
            <SpotlightCard className="p-8 h-full">
              <div className="flex items-start justify-between mb-6">
          ...
          <Reveal delay={0.2}>
            <SpotlightCard className="p-8 h-full">
              ...
              <div className="glass-card p-3 text-center">
                <CountUp value={100} prefix="$" suffix="K" className="text-xl font-bold text-gradient-gold" />
